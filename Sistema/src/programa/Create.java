	...
	public static void create() {
	    ...
	    //iterate each catalog in the ResultSet
	        while (resultSet.next()) {
	          ...
	          ((java.sql.Statement) stmt).executeUpdate("INSERT INTO USERS(USERNAME, PASSWORD, ADMIN) VALUES('admin','admin',TRUE)");
	          //Create Books table
	          ((java.sql.Statement) stmt).executeUpdate("CREATE TABLE BOOKS(BID INT NOT NULL AUTO_INCREMENT PRIMARY KEY, BNAME VARCHAR(50), GENRE VARCHAR(20), PRICE INT)");
	          //Create Issued Table
	          ((java.sql.Statement) stmt).executeUpdate("CREATE TABLE ISSUED(IID INT NOT NULL AUTO_INCREMENT PRIMARY KEY, UID INT, BID INT, ISSUED_DATE VARCHAR(20), RETURN_DATE VARCHAR(20), PERIOD INT, FINE INT)");
